 ...
 * @param {?boolean} [options.DataFrame_ignoreNested=false] - Whether to ignore columns that are nested objects.
 * If `null`, nested objects are only ignored if they cannot be loaded.
 *
